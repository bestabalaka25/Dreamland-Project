...
const teamMembers = [
  {
    name: 'Project Leader', role: 'Full-Stack Developer', era: 'Dreamland Team',
    img: 'https://via.placeholder.com/600x800/0f1628/c9a227?text=Project+Leader',
    bio: 'Built the main structure of the site, linked the sections, and kept the whole documentary running smoothly.',
    contributions: [
      { yr: '1', text: 'Set up the page structure and navigation.' },
      { yr: '2', text: 'Built the player modal and section layout.' },
      { yr: '3', text: 'Handled site styling and responsiveness.' },
    ]
  },
  {
    name: 'Frontend Dev', role: 'UI / Visual Design', era: 'Dreamland Team',
    img: 'https://via.placeholder.com/600x800/0f1628/c9a227?text=Frontend+Dev',
    bio: 'Focused on the look and feel of the documentary, making sure the site felt bold, clean, and easy to use.',
    contributions: [
      { yr: '1', text: 'Styled the hero, cards, and section headers.' },
      { yr: '2', text: 'Created smooth hover effects and animations.' },
      { yr: '3', text: 'Made the layout work on smaller screens.' },
    ]
  },
  {
    name: 'Backend Dev', role: 'Data & API', era: 'Dreamland Team',
    img: 'https://via.placeholder.com/600x800/0f1628/c9a227?text=Backend+Dev',
    bio: 'Worked behind the scenes to keep data organised and make sure the site content could be managed properly.',
    contributions: [
      { yr: '1', text: 'Organised player and story content.' },
      { yr: '2', text: 'Prepared data for dynamic modal loading.' },
      { yr: '3', text: 'Kept the site structure efficient and tidy.' },
    ]
  },
  {
    name: 'Content Lead', role: 'Research & Writing', era: 'Dreamland Team',
    img: 'https://via.placeholder.com/600x800/0f1628/c9a227?text=Content+Lead',
    bio: 'Researched the Scotland World Cup history and wrote the copy that gives the documentary its voice.',
    contributions: [
      { yr: '1', text: 'Researched key World Cup campaigns.' },
      { yr: '2', text: 'Wrote player and timeline descriptions.' },
      { yr: '3', text: 'Helped shape the documentary tone.' },
    ]
  },
  {
    name: 'QA & Testing', role: 'Quality Assurance', era: 'Dreamland Team',
    img: 'https://via.placeholder.com/600x800/0f1628/c9a227?text=QA+%26+Testing',
    bio: 'Checked the site for bugs, layout issues, and broken links so the final project feels smooth and usable.',
    contributions: [
      { yr: '1', text: 'Tested the navigation and scroll links.' },
      { yr: '2', text: 'Checked modal open and close behaviour.' },
      { yr: '3', text: 'Reviewed mobile layout and browser support.' },
    ]
  },
];
...
function openTeamModal(index) {
  ...
  document.getElementById('teamModalEra').textContent   = member.era;
  ...
  document.getElementById('teamModalBio').textContent   = member.bio;
  document.getElementById('teamModalAchList').innerHTML = member.contributions.map(c =>
    `<li><span class="yr">${c.yr}</span>
     <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2l2.9 6.9L22 9.5l-5 4.8L18.4 22 12 18.3 5.6 22 7 14.3 2 9.5l7.1-.6L12 2z"/></svg>
     <span>${c.text}</span></li>`
  ).join('');
